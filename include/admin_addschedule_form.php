  ...
  <form id="admin_addschedule_form">
    ...
    <div class="form-group row">
      ...
      <div class="col-8 col-md-10">
        <input type="text" class="form-control" name="title" id="title" placeholder="제목" value="<?=isset($mar['ma_title'])?$mar['ma_title']:''?>" autofocus required>
      </div>
    </div>

    <div class="form-group row">
      <label for="<?=($isMobileSafari == true)?'colorPicker':'colorPicker-android';?>" class="col-4 col-md-2 col-form-label">색상</label>
      <div class="col-8 col-md-10">
    ...
    <div class="form-group row">
      <div class="col-12 col-md-12">
        <div class="custom-control custom-switch">
          <input type="checkbox" name="autoswitch" class="custom-control-input" id="autoswitch" value="1" <?=$auto_checked?>>
    ...
    <div id="ma_timeswitch" class="border rounded p-4 <?=$ds_display?>">
      ...
      <div class="form-group row">
        ...
        <div class="col-8 col-md-10">
          <input type="date" name="date" class="form-control <?=$d_display?>" value="<?=isset($ma_date)?$ma_date:$today;?>" onchange="datemin();">
          <input type="datetime-local" name="datetime" class="form-control <?=$dt_display?>" value="<?=isset($ma_datetime)?$ma_datetime:$datetime;?>" onchange="datemin();">
        </div>
      </div>
      ...
      <div class="form-group row mb-0">
        ...
        <div class="col-8 col-md-10">
          <input type="date" name="date2" class="form-control <?=$d_display?>" value="<?=isset($ma_date2)?$ma_date2:$today;?>" onchange="datemax();">
          <input type="datetime-local" name="datetime2" class="form-control <?=$dt_display?>" value="<?=isset($ma_datetime2)?$ma_datetime2:$datetime;?>" onchange="datemax();">
        </div>
      </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-12 col-md-12">
        <textarea class="form-control" name="content" id="content" maxlength="100" rows="3" ><?=isset($mar['ma_content'])?$mar['ma_content']:''?></textarea>
      </div>
    </div>

    <?php if($ma_id): ?>
    <div class="card">
      <div class="text-dark" data-toggle="collapse" data-target="#collapseOne<?=$ma_id?>" aria-expanded="true" aria-controls="collapseOne<?=$ma_id?>">
        <div class="card-header text-center p-2">모임 계획 관리</div>
      </div>
      <div id="collapseOne<?=$ma_id?>" class="collapse p-3 show">
        <div class="clearfix">
          <button type="button" class="btn btn-outline-primary float-right" onclick="meeting_work('add','',<?=$ma_id?>);">
