...
if($tt_id):
  ...
  while($r = $result->fetch_assoc()):
    ...
    <tr class="gubun-odd">
      ...
      <td colspan="3" class="pb-0" style="word-wrap: break-word; word-break: break-word; overflow-wrap: break-word; max-width: 0;">
      ...
      <?php endif; ?>
      <?php if($condition):?>
        <td colspan="<?=$tt_type=='편지'?'1':'2'?>" rowspan="2" style="text-align:center; vertical-align: middle; min-width: 50px; width: <?=$tt_type=='편지'?'100px':'100px'?>;" >
    ...
    <tr class="gubun-even">
      <?php if($tt_type == '아파트' || $tt_type == '빌라' || $tt_type == '추가2'): ?>
        ...
        <td style="word-wrap: break-word; word-break: break-word; overflow-wrap: break-word;">
          <div style="padding-right: 5px;"><?=$r['h_address2']?></div>
        </td>
        <td style="word-wrap: break-word; word-break: break-word; overflow-wrap: break-word;">
          <div style="padding-right: 5px;"><?=$r['h_address3']?></div>
        </td>
      <?php else: ?>
        <td class="text-left">
        ...
        <td style="word-wrap: break-word; word-break: break-word; overflow-wrap: break-word;">
          <div style="padding-right: 5px;"><?=$r['h_address4']?></div>
        </td>
        <td style="word-wrap: break-word; word-break: break-word; overflow-wrap: break-word;">
          <div style="padding-right: 5px;"><?=$r['h_address5']?></div>
        </td>
      <?php endif; ?>
    </tr>
