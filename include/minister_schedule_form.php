...
<form id="minister_event_form">
  ...
  <div class="form-group row">
    ...
    <div class="col-8 col-md-10">
      <input type="text" class="form-control" name="title" placeholder="제목"
        value="<?= isset($me['me_title']) ? $me['me_title'] : '' ?>" autofocus required>
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-8 col-md-10">
      <textarea class="form-control" name="content" maxlength="100" rows="2"
        placeholder="일정내용"><?= isset($me['me_content']) ? $me['me_content'] : '' ?></textarea>
    </div>
  </div>
