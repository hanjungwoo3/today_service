  ...
  if($work == 'house_visit_update'){ // HOUSE 만남 체크
    ...
    if($table == 'territory'){
      ...
      if(($tt_assigned_date && !empty_date($tt_assigned_date)) || $mb_id == mb_id()){
        ...
        $territory_progress_percent = floor((($territory_progress['visit']+$territory_progress['absence'])/$territory_progress['total'])*100);
      ...
      if(($tp_assigned_date && !empty_date($tp_assigned_date)) || $mb_id == mb_id()){
        ...
        $telephone_progress_percent = floor((($telephone_progress['visit']+$telephone_progress['absence'])/$telephone_progress['total'])*100);
