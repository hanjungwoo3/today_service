...
<div id="v_guide_territory">
  <div id="container" class="container-fluid">
    ...
    <button type="button" class="btn btn-outline-success mb-4" onclick="statistics_map_view('guide');"><i
                ...
                <td class="text-center align-middle">
                  <template v-if="search_type === 'telephone'">
                    <button class="btn btn-outline-info" type="button"
                      @click="telephoneWork('record',value.id,'','','');"><i class="bi bi-list-task"></i>
                      ({{value.record_count}})</button>
                  </template>
                  <template v-else>
                    <button class="btn btn-outline-info" type="button"
                      @click="territoryWork('record',value.id,'','','');"><i class="bi bi-list-task"></i>
                      ({{value.record_count}})</button>
                  </template>
                </td>
                <td class="text-center align-middle">
