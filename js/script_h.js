...
function datemin(){
  ...
  let datetime2 = $('input[name="datetime2"]').val();
  if(date > date2) $('input[name="date2"]').val(date);
  if(datetime > datetime2) $('input[name="datetime2"]').val(datetime);
}
...
function datemax(){
  ...
  let datetime = $('input[name="datetime"]').val();
  let datetime2 = $('input[name="datetime2"]').val();
  if(date > date2) $('input[name="date"]').val(date2);
  if(datetime > datetime2) $('input[name="datetime"]').val(datetime2);
}
