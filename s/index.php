...
<body>
    ...
    <div class="container">
        ...
        <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 6px;">
            <span style="font-weight: 600; font-size: 11px; color: #555; white-space: nowrap;">날짜</span>
        ...
        <div class="bible-reading" style="display: flex; align-items: center; gap: 8px;">
            <span style="font-weight: 600; font-size: 11px; color: #555; white-space: nowrap;">성구</span>
        ...
        <div style="margin-bottom: 20px; display: flex; align-items: center; gap: 8px;">
            <span style="font-weight: 600; font-size: 11px; color: #555; white-space: nowrap;">WOL</span>
        ...
        <div id="web-fetch-section" style="margin-top: 20px; border-top: 1px solid #e0e0e0; padding-top: 15px;<?php echo (!empty($data['no_meeting']) && $data['no_meeting']) ? ' display:none;' : ''; ?>">
            <div style="background: #f8f9ff; border: 1px solid #e0e0e0; border-radius: 6px; padding: 10px; margin-bottom: 10px;">
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 6px;">
                    <span style="font-weight: 600; font-size: 12px; color: #333;">웹에서 가져오기</span>
                </div>
            ...
            <div style="background: #fff5f5; border: 1px solid #ffcccc; border-radius: 6px; padding: 10px; margin-top: 10px;">
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 6px;">
                    <span style="font-weight: 600; font-size: 12px; color: #d32f2f;">⚠️ 위험: 데이터 삭제</span>
                </div>
                <p style="font-size: 10px; color: #666; margin-bottom: 8px; line-height: 1.4;">
                    현재 주차의 데이터를 영구 삭제합니다. 삭제된 데이터는 백업 폴더에 보관되지만, 복구를 위해서는 관리자에게 문의해야 합니다. 신중히 사용하세요.
                </p>
                <button onclick="deleteData()" style="padding: 4px 8px; font-size: 10px; background: #d32f2f; color: white; border: none; border-radius: 4px; cursor: pointer; display: inline-block;">🗑️ 삭제</button>
            </div>
        </div>
    </div>
