...
class Territory extends Core
{
    ...
    public function insert($data)
    {
        ...
        return parent::insertDB(TERRITORY_TABLE, 'tt_id', $defaultValues, $data);
    }
    ...
    public function update($id, $data)
    {
        ...
        return parent::updateDB(TERRITORY_TABLE, 'tt_id', $defaultValues, $id, $data);
    }
    ...
    public function delete($id)
    {
        ...
        return parent::deleteDB(TERRITORY_TABLE, 'tt_id', $id);
    }
