...
<?php
$c_minister_assign_expiration = MINISTER_LETTER_ASSIGN_EXPIRATION?MINISTER_LETTER_ASSIGN_EXPIRATION:'7';
$mb_id = mb_id();
$where_type = "AND tt_type = '편지'";
$color_type = 'badge-info';
      ...
      <div class="list-group-item d-flex flex-nowrap justify-content-between p-2 border-light">
        <div class="flex-grow-1 pr-2">
          ...
          <div class="progress d-inline-flex align-middle w-100 mt-n1" style="height: 5px;">
            <div class="progress-bar <?= $progress == 100 ?'bg-warning':'bg-success'?>" role="progressbar" style="width:<?=$progress.'%';?>" aria-valuenow="<?=$progress;?>" aria-valuemin="0" aria-valuemax="100"></div>
          </div>
