...
<header class="navbar navbar-expand-xl fixed-top header">
  <h1 class="text-white mb-0 navbar-brand">관리자 <span class="d-xl-none">편지 구역 관리</span></h1>
  <?php echo header_menu('admin','편지 구역 관리'); ?>
</header>
    ...
    <form id="admin_territory_assign" action="" method="post">
      ...
      <div id="admin-territory-list">
          <div class="mb-2 clearfix">
              <span class="float-left" v-if="territories.length>0">총 {{Number(total).toLocaleString()}}개</span>
              <button type="button" class="btn btn-outline-primary float-right" v-on:click="territoryWork('add','','','','','letter');">
              ...
              <table class="table mb-0" style="min-width: 1400px;">
                  ...
                  <thead class="thead-light">
                      <tr>
                          ...
                          <th class="text-center align-middle">배정 상태</th>
                          ...
                          <tr v-for="(value, index) in territories">
                              ...
                              <td class="text-center align-middle">
                                <div class="dropdown">
                                    ...
                                    <button class="dropdown-item" type="button" v-on:click="territoryWork('edit',value.id,value.num,'','','letter');">구역 수정</button>
                                    <button class="dropdown-item" type="button" v-on:click="territoryWork('copy',value.id,value.num,'','','letter');">구역 복제</button>
